...
@Tag(
        name = "Producers",
        description = "Consultas relacionadas aos produtores vencedores do Golden Raspberry Awards"
)
public class ProducerAwardIntervalResource {
    ...
    public ProducerAwardIntervalResource(ProducerAwardIntervalService producerAwardIntervalService) {
        this.producerAwardIntervalService = producerAwardIntervalService;
    }

    @GET
    @Operation(
            summary = "Consulta os produtores com maior e menor intervalo entre premios",
    ...
    @APIResponse(
            ...
            content = @Content(
                    ...
                    schema = @Schema(implementation = AwardIntervalResponse.class)
            )
    )
    public AwardIntervalResponse getProducerAwardIntervals() {
        ...
        return producerAwardIntervalService.calculateProducerAwardIntervals();
    }
}
